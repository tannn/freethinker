...
public enum FloatingPanelAccessibility {
    public enum Identifier {
        ...
        public static let copyTarget = "floating_panel.action.copy_target"
    ...
    public enum Label {
        ...
        public static let copyTarget = "Provocation content"
    ...
    public enum Hint {
        public static let copyTarget = "Click to copy the current provocation to the clipboard"
